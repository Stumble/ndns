...
#ifndef NDNS_VALIDATOR_CERTIFICATE_FETCHER_NDNS_APPCERT
#define NDNS_VALIDATOR_CERTIFICATE_FETCHER_NDNS_APPCERT
...
public:
  explicit
  CertificateFetcherAppCert(Face& face, size_t startComponentIndex = 0);
