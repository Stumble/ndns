...
class ValidatorAppCert : public security::v2::Validator
{
public:
  explicit
  ValidatorAppCert(Face& face, const std::string& confFile)
    : Validator(make_unique<::ndn::security::v2::ValidationPolicySimpleHierarchy>(),
...
public:
    ...
    , m_validator(m_face, TEST_CONFIG_PATH "/" "validator.conf")
  {
    ...
    ValidatorNdns validatorOnlyForConstructServer(m_face, TEST_CONFIG_PATH "/" "validator.conf");
