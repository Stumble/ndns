...
NDNS_LOG_INIT("CertificateFetcherAppCertTest")

BOOST_AUTO_TEST_SUITE(CertificateFetcherAppCert)
...
public:
  ...
  {
    m_randomDsk = createRoot(Name(m_randomId).append("NDNS")); // generate a random cert
